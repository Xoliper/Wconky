...
private:
    ...
    unsigned long int m_ulMMTimerElapsed;
    unsigned long int m_ulMMTimerStart;
...
public:
    ...
    //----------------------------------------------------------
    CTimer( void )
        : m_fTime1(0.0f), m_fTime2(0.0f), m_fDiffTime(0.0f), m_fFPS(0.0f), m_iFramesElapsed(0)
    { m_i64PerformanceTimerStart = m_i64PerformanceTimerElapsed = m_ulMMTimerElapsed = m_ulMMTimerStart = m_i64Frequency = m_fResolution = m_bPerformanceTimer = 0;}
